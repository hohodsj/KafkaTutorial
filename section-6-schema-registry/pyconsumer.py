...
def make_consumer() -> DeserializingConsumer:
    ...
    schemas_reg_client = SchemaRegistryClient({'url': os.environ['SCHEMA_REGISTRY_URL']})
    # create a AvroDeserializer
    avro_deserializer = AvroDeserializer(schemas_reg_client,
